function getList(products, prices) {
  prices.sort((a,b) => a.price - b.price);
  prices.forEach(price => console.log(findName(products, price.id)));
}
...
function findName(arr, target) {
  ...
  while(left <= right) {
    ...
    else if(arr[mid].id > target) right = mid - 1;
